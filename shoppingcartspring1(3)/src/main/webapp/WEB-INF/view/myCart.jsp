...
<body>
	...
	<div id="all">
					...
					<div class="col-md-5">
						<ul class="breadcrumb">
							...
							<li><a href="<spring:url value="/" />">CONTINUE
									SHOPPING</a>
							<li>
							<li><a href="<spring:url value="/checkout"/>"><span
				...
				<div class="container">
					<div class="row">
						...
						<div class="row margin-left25">
							...
							<br>
							<br>
							<%-- <a href="<c:url value="/usercart/cart/update/${cartId}"/>"
											class="btn btn-danger btnAction">Update
										</a> --%>
							<br>
							<br>
							<%-- <a href="<c:url value="/usercart/cart/refreshCart/${cartId}"/>"
		...
		<div data-role="footer" style="text-align: center;">
			...
			<a href="<spring:url value="/shippingdetails"/>"
				class="ui-btn ui-corner-all ui-shadow ui-btn-icon-left">BUY NOW</a>
			<a href="<c:url value="/index"/>"
				class="ui-btn ui-corner-all ui-shadow ui-icon-plus ui-btn-icon-left">ADD
				MORE PRODUCTS</a>
