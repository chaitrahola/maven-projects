	...
	<div class="h_menu4"><!-- start h_menu4 -->
		<div class="container">
				...
				<ul class="nav">
					...
					<li class="active"><a href="wishlist" data-hover="Wish List">Wish List</a></li>
				 </ul>
...
<div class="about">
    <div class="container">
         <div class="register">
		  	  ...
		  	  <p class="cart">You have no items in your shopping cart.<br>Click<a href="index"> here</a> to continue shopping</p>
		 </div>
	</div>
</div>
<div class="footer_bg">
