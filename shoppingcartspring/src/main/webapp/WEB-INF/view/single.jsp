...
<script type="text/javascript" src="resource/js/hover_pack.js"></script>
  	...
  	<div class="container">
	   ...
	   <div class="col-md-9 single_right">
	       ...
	       <div class="single_grid">
			    ...
			    <a href="reservation" title="Online Reservation" class="btn bt1 btn-primary btn-normal btn-inline " target="_self">Buy</a>
			</div>
		    <div class="clearfix"> </div>
				</div>
          	    <div class="clearfix"></div>
	    ...
	    <div class="related_products">
	     <div class="col-md-4 top_grid1-box1 top_grid2-box2"><a href="single">
	     	<div class="grid_1">
	     	  ...
	     	  <div class="grid_2">
	     	  	...
	     	  	<ul class="grid_2-bottom">
	     	  		...
	     	  		<li class="grid_2-right"><a href="single" title="Get It" class="btn btn-primary btn-normal btn-inline " target="_self">Get It</a></li>
	     	  		<div class="clearfix"> </div>
	     	  	</ul>
	     	  </div>
	     	</div>
	     </a></div>
	    <div class="col-md-4 top_grid1-box1"><a href="single">
	     	<div class="grid_1">
	     	  <div class="b-link-stroke b-animate-go  thickbox">
