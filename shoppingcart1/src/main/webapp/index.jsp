...
<script src ="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<c:url value="resouces/css/bootstrap.min.css"/>" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<c:url value="resouces/css/business-casual.css"/>" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="resources/index.html">Home</a>
                    </li>
                    <li>
                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="resources/img-responsive img-full" src="resources/img/slide-1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="resources/img-responsive img-full" src="resources/img/slide-2.jpg"alt="">
                            </div>
                            <div class="item">
                                <img class="resources/img-responsive img-full" src="resources/img/slide-3.jpg" alt="">
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <img class="resources/img-responsive img-border img-left" src="resources/img/intro-pic.jpg" alt="">
                    <hr class="visible-xs">
