...
<!-- start menu -->
<link href="resource/css/memenu.css" rel="stylesheet" type="text/css" media="all" />
	...
	<div class="pro-du">
		<div class="container">
			...
			<div class="col-md-3 prod-rgt">
				<div class=" pro-tp">
					<div class="pl-lft">
						<a href="single"><img class="img-responsive" src="images/l2.jpg" alt=""></a>
					</div>
					<div class="pl-rgt">
						<h6><a href="single">TRIBECA LIVING</a></h6>
						<p><a href="single">450$</a></p>
					</div>
						<div class="clearfix"></div>
				</div>
				<div class=" pro-tp">
					<div class="pl-lft">
						<a href="single"><img class="img-responsive" src="images/l3.jpg" alt=""></a>
					</div>
					<div class="pl-rgt">
						<h6><a href="single">TRIBECA LIVING</a></h6>
						<p><a href="single">450$</a></p>
				...
				<div class=" pro-tp">
					<div class="pl-lft">
						<a href="single"><img class="img-responsive" src="images/l1.jpg" alt=""></a>
					</div>
					<div class="pl-rgt">
						<h6><a href="single">TRIBECA LIVING</a></h6>
						<p><a href="single">450$</a></p>
